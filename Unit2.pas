...
procedure TForm2.ButtonClearDataClick(Sender: TObject);
...
procedure TForm2.ButtonCopyDataClick(Sender: TObject);
var i: Integer;
    tdt: TDateTime;
...
procedure TForm2.ButtonLoadDataClick(Sender: TObject);
begin
...
procedure TForm2.dsSourceDataChange(Sender: TObject; Field: TField);
begin
  SourceRecordCount.Caption := IntToStr(dbfSource.RecordCount);
end;

procedure TForm2.dsVerifikasiDataChange(Sender: TObject; Field: TField);
begin
  TargetRecordCount.Caption := IntToStr(tbVerifikasi.RecordCount);
end;

procedure TForm2.EditCariNamaChange(Sender: TObject);
begin
  SearchNama;
end;

procedure TForm2.EditCariNRPChange(Sender: TObject);
begin
  SearchNRP;
end;
